...
version_menu.add_command(label="• Check Version",
                         command=check_version)  # Add your command here
version_menu.add_command(label="• Release Notes",
                         command=open_version_info_file)
...
instructions_label = tk.Label(window, text="Enter the URL of the file to download:",
                              bg="#E7E9EA", fg="#20211A", justify='center', font=("Tahoma", 11))
...
paste_button = tk.Button(window, text="Paste URL", bg="#E7E9EA",
                         fg="#20211A", justify='center', font=("Tahoma", 11), command=paste_url)
...
browse_button = tk.Button(window, text="Browse", bg="#E7E9EA", fg="#20211A",
                          justify='center', font=("Tahoma", 11), command=select_output_dir)
...
download_button = tk.Button(window, text="Download", bg="#E7E9EA", fg="#20211A",
                            justify='center', font=("Tahoma", 12), command=download_file)
